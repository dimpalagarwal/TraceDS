...
import PrimControls from "../../../components/Visualizer/PrimControls";
...
function PrimVisualizer() {
    ...
    return (
        ...
        >
            <h1 className="text-4xl" style={{color: "var(--heading)",}}>Prim's Algorithm</h1>
            <p className="mt-3 text-lg" style={{color: "var(--muted)",}}>Minimum Spanning Tree using a greedy approach.</p>
